...
"""--pretrained_model gpt2-medium --cond_text "James Harden is not a good player." --discrim sentiment --class_label 2
 ...
 --gumbel_temperature 10 --detach --gradient_accumulation_steps 4"""
...
def run_prompt_trigger_example(
    ...
    generate_prompt(model, tokenizer, num_of_triggers, learning_rate=learning_rate, adam_epsilon=adam_epsilon,
                    ...
                    detach=detach, gradient_accumulation_steps=gradient_accumulation_steps,
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gradient_accumulation_steps", type=int, default=1, help="if > 1, accumulate multiple steps before backprop")
