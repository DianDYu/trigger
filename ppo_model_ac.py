...
from transformers import BlenderbotPreTrainedModel, BlenderbotModel
...
class BlenderWithValueModel(BlenderbotPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        config.num_labels = 1
        # default value from lvwerra/gpt2-imdb (same as gpt2-medium) for value head
